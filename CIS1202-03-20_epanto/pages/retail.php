...
$product = isset($_POST["productInput"]) ? $_POST["productInput"] : null;
$quantity = isset($_POST["quantityInput"]) ? $_POST["quantityInput"] : null;

function displayOrder($name, $product, $quantity)
{
  ...
  <main
    ...
    <div
      ...
      <div class="card-header">
        ...
        <h1 class="custom-text-primary m-0">Retail:</h1>
        <p>Customer Order Form.</p>
        <hr />
      </div>
      <div class="card-body d-flex flex-column gap-1 py-0">
        ...
        <div class="text-white mt-4 d-flex gap-2 justify-content-center">
          ...
          if ($name && $quantity && $product) {
            echo "<p class='alert alert-primary' role='alert'>" . displayOrder($name, $product, $quantity) . "</p>";
          }
          ?>
        </div>
      </div>
