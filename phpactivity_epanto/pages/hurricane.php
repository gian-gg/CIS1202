<?php
$windSpeed = isset($_POST["windSpeedInput"]) ? $_POST["windSpeedInput"] : null;
  ...
  <main
    ...
    <div
      ...
      <div class="card-header">
        ...
        <h1 class="custom-text-primary m-0">Meteorology:</h1>
        <p>Hurricane Wind Speed Category Calculator.</p>
        <hr />
      </div>
      <div class="card-body d-flex flex-column gap-1 py-0">
        <form method="post">
          <div class="mb-3">
            <label for="windSpeedInput" class="form-label">Hurricane Wind Speed</label>
            <input
              type="number"
        ...
        <div class="text-white mt-4 d-flex gap-2 justify-content-center">
          <?php
          if ($windSpeed) {
            echo "<h5>Hurricane Category:</h5>";
            echo "<p>" . categorizeHurricane($windSpeed) . "</p>";
          }
          ?>
        </div>
      </div>
